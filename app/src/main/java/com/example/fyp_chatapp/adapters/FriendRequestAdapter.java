...
import com.example.fyp_chatapp.databinding.ItemContainerFriendRequestBinding;
...
public class FriendRequestAdapter extends RecyclerView.Adapter<FriendRequestAdapter.FriendRequestViewHolder>{
    ...
    class FriendRequestViewHolder extends RecyclerView.ViewHolder {
        ...
        void setUserData(@NonNull FriendRequest friendRequest){
            binding.textName.setText(friendRequest.requestFromName);
            binding.textEmail.setText(friendRequest.requestFromEmail);
            binding.imageProfile.setImageBitmap(getUserImage(friendRequest.requestFromImage));
