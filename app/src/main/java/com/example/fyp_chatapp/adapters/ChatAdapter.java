...
import com.example.fyp_chatapp.databinding.ItemContainerReceivedMessageBinding;
import com.example.fyp_chatapp.databinding.ItemContainerSentMessageBinding;
...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemViewType(int position) {
        if (chatMessages.get(position).senderId.equals(senderId)) { //如果是自己发出的消息, 则返回VIEW_TYPE_SENT
